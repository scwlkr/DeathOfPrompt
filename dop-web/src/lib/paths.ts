// Single source of truth for every mutable-state path DOP touches.
//
// All runtime state lives under `dop-web/data/` — which is gitignored, so
...
export const API_KEY_FILE = path.join(DATA_ROOT, '.dop-api-key');
